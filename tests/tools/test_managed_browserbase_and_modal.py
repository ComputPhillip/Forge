...
def _enable_managed_nous_tools(monkeypatch):
    ...
    forge_cli.auth and forge_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("forge_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("forge_cli.models.check_nous_free_tier", lambda: False)
