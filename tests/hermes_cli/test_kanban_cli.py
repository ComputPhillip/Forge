"""Tests for the kanban CLI surface (forge_cli.kanban)."""
...
from forge_cli import kanban as kc
...
def test_kanban_bypasses_active_session_guard():
    from forge_cli.commands import should_bypass_active_session

    assert should_bypass_active_session("kanban")


def test_kanban_in_autocomplete_table():
    from forge_cli.commands import COMMANDS, SUBCOMMANDS
...
def test_kanban_not_gateway_only():
    ...
    from forge_cli.commands import COMMAND_REGISTRY
