"""Tests for forge_cli.security_advisories.
...
import forge_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full forge_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "forge_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
            "forge_cli.config.save_config",
