...
def test_recommended_update_command_defaults_to_hermes_update(monkeypatch):
    ...
    with patch("forge_cli.config.get_managed_update_command", return_value=None), \
         patch("forge_cli.config.detect_install_method", return_value="git"):
...
def test_cmd_update_blocks_managed_homebrew(monkeypatch, capsys):
    ...
    with patch("forge_cli.main.subprocess.run") as mock_run:
