"""
Tests for timezone support (forge_time module + integration points).
...
def _reset_hermes_time_cache():
    """Reset the forge_time module cache (replacement for removed reset_cache)."""
    forge_time._cached_tz = None
    forge_time._cached_tz_name = None
    forge_time._cache_resolved = False


# =========================================================================
# forge_time.now() — core helper
# =========================================================================
...
class TestHermesTimeNow:
    ...
    def test_invalid_timezone_falls_back(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="forge_time"):
            result = forge_time.now()
