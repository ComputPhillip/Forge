...
from forge_cli.timeouts import get_provider_request_timeout, get_provider_stale_timeout
from forge_constants import PARTIAL_STREAM_STUB_ID, FINISH_REASON_LENGTH
...
def try_activate_fallback(agent, reason: "FailoverReason | None" = None) -> bool:
    ...
    try:
        ...
        if not fb_api_key_hint:
            ...
            # _normalize_custom_provider_entry in forge_cli/config.py).
