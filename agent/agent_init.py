...
from forge_cli.timeouts import get_provider_request_timeout
...
def init_agent(
    ...
    agent._cache_ttl = "5m"
    try:
        from forge_cli.config import load_config as _load_pc_cfg
    ...
    from forge_logging import setup_logging, setup_verbose_logging
    ...
    if agent.verbose_logging:
        ...
        # on the fact that forge_logging.setup_logging() does not
        ...
        # handler level inside forge_logging.py, not here.
        pass
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        try:
            from forge_cli.config import load_config as _load_br_cfg
    ...
    try:
        from forge_cli.config import load_config as _load_sess_cfg
    ...
    try:
        from forge_cli.config import load_config as _load_agent_config
    ...
    if _config_context_length is None and _custom_providers:
        try:
            from forge_cli.config import get_custom_provider_context_length
    ...
    if _engine_name != "compressor":
        ...
        if _selected_engine is None:
            try:
                from forge_cli.plugins import get_plugin_context_engine
