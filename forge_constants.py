...
def get_hermes_home() -> Path:
    ...
    template in ``forge_cli/gateway.py`` and the kanban dispatcher in
    ``forge_cli/kanban_db.py``).  See https://github.com/NousResearch/hermes-agent/issues/18594.
    """
...
def get_config_path() -> Path:
    ...
    in 7+ files (skill_utils.py, forge_logging.py, forge_time.py, etc.).
    """
