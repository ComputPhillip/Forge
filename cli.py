...
# IMPORTANT: forge_bootstrap must be the very first import — UTF-8 stdio
# on Windows.  No-op on POSIX.  See forge_bootstrap.py for full rationale.
try:
    import forge_bootstrap  # noqa: F401
except ModuleNotFoundError:
    # Graceful fallback when forge_bootstrap isn't registered in the venv
...
from forge_cli.fallback_config import get_fallback_chain
...
try:
    from forge_cli.pt_input_extras import install_shift_enter_alias, install_ctrl_enter_alias
...
from forge_cli.banner import _format_context_length, format_banner_version_label
...
from forge_cli.browser_connect import (
...
def _parse_reasoning_config(effort: str) -> dict | None:
    ...
    from forge_constants import parse_reasoning_effort
...
def load_cli_config() -> Dict[str, Any]:
    ...
    defaults = {
        ...
        "display": {
            "compact": False,
            "resume_display": "full",
            # Recap tuning for /resume — see forge_cli/config.py DEFAULT_CONFIG.
            "resume_exchanges": 10,
    ...
    if config_path.exists():
        try:
            with open(config_path, "r", encoding="utf-8") as f:
                from forge_cli.config import _normalize_root_model_keys
    ...
    from forge_cli.config import _expand_env_vars
    defaults = _expand_env_vars(defaults)

    # Apply terminal config to environment variables (so terminal_tool picks them up)
    terminal_config = defaults.get("terminal", {})
    
    # Normalize config key: the new config system (forge_cli/config.py) and all
...
try:
    from forge_logging import setup_logging
...
try:
    from forge_cli.config import print_config_warnings
...
try:
    from forge_cli.skin_engine import init_skin_from_config
...
from forge_cli.banner import build_welcome_banner
from forge_cli.commands import SlashCommandCompleter, SlashCommandAutoSuggest
...
from forge_cli.callbacks import prompt_for_secret
...
def _run_cleanup():
    ...
    try:
        from forge_cli.plugins import invoke_hook as _invoke_hook
...
def _run_state_db_auto_maintenance(session_db) -> None:
    ...
    :func:`forge_cli.config.load_config` (the authoritative loader that
    ...
    if session_db is None:
        return
    try:
        from forge_cli.config import load_config as _load_full_config
        from forge_constants import get_hermes_home as _get_hermes_home
...
def _run_checkpoint_auto_maintenance() -> None:
    ...
    :func:`forge_cli.config.load_config`. Honours ``auto_prune`` /
...
def _install_skin_light_mode_hook() -> None:
    ...
    try:
        from forge_cli.skin_engine import SkinConfig  # type: ignore[import]
    except Exception:
        return
...
class _SkinAwareAnsi:
    ...
    def __str__(self) -> str:
        if self._cached is None:
            try:
                from forge_cli.skin_engine import get_active_skin
...
from forge_constants import is_termux as _is_termux_environment
...
def _build_compact_banner() -> str:
    ...
    if os.environ.get("HERMES_FAST_STARTUP_BANNER") == "1":
        from forge_cli import __release_date__ as _release_date
        from forge_cli import __version__ as _version
...
def _get_plugin_cmd_handler_names() -> set:
    ...
    try:
        from forge_cli.plugins import get_plugin_commands
...
class HermesCLI:
    ...
    def __init__(
        ...
        if self.model == _DEFAULT_CONFIG_MODEL:
            ...
            if "localhost" in _base_url or "127.0.0.1" in _base_url:
                from forge_cli.runtime_provider import _auto_detect_local_model
        ...
        # by `hermes chat --ignore-rules` in forge_cli/main.py. When true we
    ...
    def set_voice_record_key_cache(self, raw_key: object) -> None:
        ...
        """
        try:
            from forge_cli.voice import format_voice_record_key_for_status
    ...
    def _normalize_model_for_provider(self, resolved_provider: str) -> bool:
        ...
        try:
            from forge_cli.model_normalize import (
        ...
        if resolved_provider == "copilot":
            try:
                from forge_cli.models import copilot_model_api_mode, normalize_copilot_model_id
        ...
        if resolved_provider in {"opencode-zen", "opencode-go"}:
            try:
                from forge_cli.models import normalize_opencode_model_id, opencode_model_api_mode
    ...
    def _ensure_runtime_credentials(self) -> bool:
        ...
        """
        from forge_cli.runtime_provider import (
        ...
        if not self.model and resolved_provider:
            try:
                from forge_cli.models import get_default_model_for_provider
    ...
    def _resolve_turn_agent_config(self, user_message: str) -> dict:
        ...
        """
        from forge_cli.models import resolve_fast_mode_overrides
    ...
    def _show_security_advisories(self):
        ...
        """
        try:
            from forge_cli.security_advisories import (
                detect_compromised,
                startup_banner,
            )
    ...
    def show_banner(self):
        ...
        from forge_cli.model_switch import is_nous_hermes_non_agentic
    ...
    def _try_attach_clipboard_image(self) -> bool:
        ...
        """
        from forge_cli.clipboard import save_clipboard_image
    ...
    def _handle_paste_command(self):
        ...
        from forge_cli.clipboard import has_clipboard_image
    ...
    def _show_session_status(self):
        ...
        # 2.1.114's /recap.
        try:
            from forge_cli.session_recap import build_recap
            recap = build_recap(
    ...
    def _fast_command_available(self) -> bool:
        try:
            from forge_cli.models import model_supports_fast_mode
        except Exception:
            return False
        agent = getattr(self, "agent", None)
    ...
    def show_help(self):
        ...
        from forge_cli.commands import COMMANDS_BY_CATEGORY

        try:
            from forge_cli.skin_engine import get_active_help_header
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in forge_cli/colors.py
        ...
        from forge_cli.tools_config import _get_platform_tools
        from forge_cli.config import load_config
    ...
    def _show_recent_sessions(self, *, reason: str = "history", limit: int = 10) -> bool:
        ...
        from forge_cli.main import _relative_time
    ...
    def _handle_handoff_command(self, cmd_original: str) -> bool:
        ...
        """
        from forge_state import format_session_db_unavailable
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from forge_cli.main import _resolve_session_by_name_or_id
    ...
    def _run_curses_picker(self, title: str, items: list[str], default_index: int = 0) -> int | None:
        ...
        import threading
        from forge_cli.curses_ui import curses_single_select
    ...
    def _apply_model_switch_result(self, result, persist_global: bool) -> None:
        ...
        try:
            from forge_cli.model_switch import resolve_display_context_length
    ...
    def _handle_model_picker_selection(self, persist_global: bool = False) -> None:
        ...
        if stage == "provider":
            ...
            if not model_list:
                try:
                    from forge_cli.models import provider_model_ids
        ...
        if stage == "model":
            ...
            if selected < len(model_list):
                from forge_cli.model_switch import switch_model
    ...
    def _handle_model_switch(self, cmd_original: str):
        ...
        """
        from forge_cli.model_switch import switch_model, parse_model_flags
        from forge_cli.providers import get_label
        ...
        # clobber disk config.
        from forge_cli.inventory import build_models_payload, load_picker_context
    ...
    def _handle_codex_runtime(self, cmd_original: str) -> None:
        ...
        """
        from forge_cli import codex_runtime_switch as crs
    ...
    def _should_handle_model_command_inline(self, text: str, has_images: bool = False) -> bool:
        ...
        if not text or has_images or not _looks_like_slash_command(text):
            return False
        try:
            from forge_cli.commands import resolve_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to forge_cli.curator so the CLI and the `hermes curator`
        ...
        try:
            from forge_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_kanban_command(self, cmd: str):
        ...
        """
        from forge_cli.kanban import run_slash
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to forge_cli.skills_hub."""
        from forge_cli.skills_hub import handle_skills_slash
    ...
    def process_command(self, command: str) -> bool:
        ...
        # change in forge_cli/commands.py instead of touching every dispatch site.
        from forge_cli.commands import resolve_command as _resolve_cmd
        ...
        if canonical in {"quit", "exit"}:
            ...
            if self._app:
                ...
                try:
                    from forge_cli.tips import get_random_tip
                    _tip = get_random_tip()
                    try:
                        from forge_cli.skin_engine import get_active_skin
            ...
            from forge_cli.config import reload_env
            count = reload_env()
            ...
            try:
                from forge_cli.plugins import get_plugin_manager
            ...
            # Check for skill slash commands (/gif-search, /axolotl, etc.)
                ...
                from forge_cli.commands import COMMANDS
    ...
    def _get_goal_manager(self):
        ...
        """
        try:
            from forge_cli.goals import GoalManager
            from forge_cli.config import load_config
        except Exception as exc:
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from forge_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
    ...
    def _handle_footer_command(self, cmd_original: str) -> None:
        ...
        """
        from forge_cli.config import load_config
        from forge_cli.colors import Colors as _Colors
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from forge_cli.models import _is_anthropic_fast_model
            agent = getattr(self, "agent", None)
            model = getattr(agent, "model", None) or getattr(self, "model", None)
    ...
    def _handle_debug_command(self):
        ...
        from forge_cli.debug import run_debug_share
    ...
    def _handle_update_command(self) -> bool:
        ...
        when cancelled.
        """
        from forge_cli.config import is_managed, format_managed_message
    ...
    def _show_usage(self):
        ...
        if self.verbose:
            ...
            # Console quietness is enforced by forge_logging not
    ...
    def _check_config_mcp_changes(self) -> None:
        ...
        from forge_cli.config import get_config_path as _get_config_path
    ...
    def _print_exit_summary(self):
        ...
        if msg_count > 0:
            ...
            try:
                from forge_cli.skin_engine import get_active_goodbye
    ...
    def _get_tui_prompt_symbols(self) -> tuple[str, str]:
        ...
        """
        try:
            from forge_cli.skin_engine import get_active_prompt_symbol
    ...
    def _build_tui_style_dict(self) -> dict[str, str]:
        ...
        try:
            from forge_cli.skin_engine import get_prompt_toolkit_style_overrides
    ...
    def run(self):
        ...
        try:
            ...
            if not is_seen(self.config, OPENCLAW_RESIDUE_FLAG) and detect_openclaw_residue():
                ...
                try:
                    from forge_cli.config import get_config_path as _get_cfg_path_resid
        ...
        try:
            ...
            if hasattr(self, '_session_db') and self._session_db and self.agent:
                ...
                if getattr(self, '_delete_session_on_exit', False):
                    try:
                        from forge_constants import get_hermes_home as _ghh
