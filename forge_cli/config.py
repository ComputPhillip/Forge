...
from forge_cli.default_soul import DEFAULT_SOUL_MD
...
# Re-export from forge_constants — canonical definition lives there.
from forge_constants import get_hermes_home  # noqa: F811,E402
...
DEFAULT_CONFIG = {
    ...
    "security": {
        ...
        # ``forge_cli/security_advisories.py`` for the catalog.
        "acked_advisories": [],
...
def get_custom_provider_context_length(
    ...
    used by:
      ...
      * ``forge_cli.model_switch.resolve_display_context_length`` (``/model`` confirmation display)
