...
from forge_cli.config import get_project_root, get_hermes_home, get_env_path
...
from forge_cli.models import _HERMES_USER_AGENT
from forge_cli.vercel_auth import describe_vercel_auth
from forge_constants import OPENROUTER_MODELS_URL
...
from forge_constants import is_termux as _is_termux
...
def _has_healthy_oauth_fallback_for_apikey_provider(provider_label: str) -> bool:
    ...
    if normalized in {"google / gemini", "gemini"}:
        try:
            from forge_cli.auth import get_gemini_oauth_auth_status
            return bool((get_gemini_oauth_auth_status() or {}).get("logged_in"))
        except Exception:
            return False
    if normalized == "minimax":
        try:
            from forge_cli.auth import get_minimax_oauth_auth_status
...
def _check_gateway_service_linger(issues: list[str]) -> None:
    ...
    try:
        ...
        from forge_cli.service_manager import detect_service_manager
...
def _build_apikey_providers_list() -> list:
    ...
    try:
        ...
        try:
            from forge_cli.providers import normalize_provider as _normalize_provider
...
def run_doctor(args):
    ...
    if config_path.exists():
        ...
        try:
            ...
            try:
                ...
                pass
            try:
                from forge_cli.config import get_compatible_custom_providers as _compatible_custom_providers
                from forge_cli.providers import (
            ...
            if runtime_provider and runtime_provider not in ("auto", "custom"):
                try:
                    if runtime_provider == "openrouter":
                        ...
                        from forge_cli.auth import PROVIDER_REGISTRY, get_auth_status
        ...
        if fallback_config.exists():
            ...
            if should_fix:
                ...
                if example_config.exists():
                    ...
                    from forge_cli.config import DEFAULT_CONFIG, save_config
    ...
    if config_path.exists():
        try:
            from forge_cli.config import check_config_version, migrate_config
        ...
        try:
            from forge_cli.config import validate_config_structure
    ...
    try:
        from forge_constants import is_container as _is_container
    ...
    try:
        from forge_cli.profiles import list_profiles, _get_wrapper_dir, profile_exists
        import re as _re
