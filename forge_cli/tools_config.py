...
from forge_cli.nous_subscription import (
...
from forge_cli.cli_output import (  # noqa: E402 — late import block
...
def _xai_credentials_present() -> bool:
    ...
    """
    try:
        from forge_cli.auth import _read_xai_oauth_tokens
...
def _get_effective_configurable_toolsets():
    ...
    try:
        from forge_cli.plugins import discover_plugins, get_plugin_toolsets
...
from forge_cli.platforms import PLATFORMS as _PLATFORMS_REGISTRY
...
def _run_post_setup(post_setup_key: str):
    ...
    if post_setup_key in {"agent_browser", "browserbase"}:
        ...
        try:
            from forge_cli.auth import login_spotify_command
        except Exception as exc:
