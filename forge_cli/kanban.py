...
from forge_cli import kanban_swarm as ks
from forge_cli.profiles import get_active_profile_name, get_profile_dir, seed_profile_skills
...
def _cmd_specify(args: argparse.Namespace) -> int:
    ...
    from forge_cli import kanban_specify as spec
