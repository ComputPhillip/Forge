...
from forge_cli.config import get_hermes_home, get_config_path, read_raw_config
from forge_constants import OPENROUTER_BASE_URL, secure_parent_dir
...
def _resolve_api_key_provider_secret(
    ...
    if provider_id == "copilot":
        ...
        try:
            from forge_cli.copilot_auth import resolve_copilot_token, get_copilot_api_token
...
def _nous_shared_auth_dir() -> Path:
    ...
    :func:`forge_constants.get_default_hermes_root` returns — so
...
def _prompt_model_selection(
    ...
    """
    from forge_cli.models import _format_price_per_mtok
...
def _save_model_choice(model_id: str) -> None:
    ...
    """
    from forge_cli.config import save_config, load_config
