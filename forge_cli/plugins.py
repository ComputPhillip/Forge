...
class PluginContext:
    ...
    def register_auxiliary_task(
        ...
        *,
        ...
        # Lazy import to avoid circular: forge_cli.main imports plugins indirectly
        from forge_cli.main import _AUX_TASKS as _BUILTIN_AUX_TASKS
...
class PluginManager:
    ...
    def discover_and_load(self, force: bool = False) -> None:
        ...
        #
        # Repo-shipped plugins live next to forge_cli/. Two layouts are
