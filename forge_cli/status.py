...
from forge_cli.auth import AuthError, resolve_provider
from forge_cli.colors import Colors, color
from forge_cli.config import get_env_path, get_env_value, get_hermes_home, load_config
from forge_cli.models import provider_label
from forge_cli.nous_subscription import get_nous_subscription_features
from forge_cli.runtime_provider import resolve_requested_provider
...
def show_status(args):
    ...
    if _effective_provider_label() == "LM Studio":
        from forge_cli.models import probe_lmstudio_models
        model_cfg = config.get("model")
    ...
    try:
        from forge_cli.gateway import get_gateway_runtime_snapshot, _format_gateway_pids
